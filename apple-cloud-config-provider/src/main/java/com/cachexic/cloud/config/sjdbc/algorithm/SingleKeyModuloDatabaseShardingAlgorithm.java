...
package com.cachexic.cloud.config.sjdbc.algorithm;
...
public final class SingleKeyModuloDatabaseShardingAlgorithm implements
    SingleKeyDatabaseShardingAlgorithm<Long> {

...
public interface BaseDao<T extends PojoBaseEntity, Q extends PojoBaseQuery> {
     ...
     * @return
     */
    int deleteById(@Param("id") Long id, @Param("updateUserId") Long updateUserId,@Param("updateUserName") String updateUserName);
     ...
     * @return
     */
    int deleteByIds(@Param("ids") List<Long> ids,@Param("updateUserId") Long updateUserId,@Param("updateUserName") String updateUserName);

 ...
 */
public class UserControllerTest extends TestParent {
  ...
  public void whenQuerySuccess() throws Exception {
    String result = mockMvc.perform(
        get("/user").param("username", "jojo").param("age", "18").param("ageTo", "60")
            .param("xxx", "yyy")
            // .param("size", "15")
            // .param("page", "3")
            // .param("sort", "age,desc")
...
//				.andExpect(jsonPath("$.id").value("1"))
  ...
  public void whenUpdateSuccess() throws Exception {
    ...
    System.out.println(date.getTime());
    String content =
        "{\"id\":\"1\", \"username\":\"tom\",\"password\":null,\"birthday\":" + date.getTime()
            + "}";

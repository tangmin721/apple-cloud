 ...
 * 运行方法请参考README。
 *
 * 本示例中的并不包括OSS Java SDK的所有功能，详细功能及使用方法，请参看“SDK手册 > Java-SDK”， 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/preface.html?spm=5176.docoss/sdk/java-sdk/。
 *
 * 调用OSS Java SDK的方法时，抛出异常表示有错误发生；没有抛出异常表示成功执行。 当错误发生时，OSS Java SDK的方法会抛出异常，异常中包括错误码、错误信息，详细请参看“SDK手册
 * > Java-SDK > 异常处理”， 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/exception.html?spm=5176.docoss/api-reference/error-response。
 *
 ...
 *
 * OSS的文档中心地址是：https://help.aliyun.com/document_detail/oss/user_guide/overview.html。 OSS Java
 * SDK的文档地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/install.html?spm=5176.docoss/sdk/java-sdk。
 */

package com.cachexic.cloud.provider.system.oss;
...
public class HelloOSS {
  ...
  private static final Logger logger = Logger.getLogger(HelloOSS.class);
  ...
  private static String accessKeyId = "LTAItB1P4wtW0XWc";
  private static String accessKeySecret = "itHJ9Hz99TKFqc5XxYRilsaBfE3QEz";

  // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
  // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
  private static String bucketName = "dusnp";
  ...
  public static void main(String[] args) {
    ...
    try {
     ...
     /* BucketInfo info = ossClient.getBucketInfo(bucketName);
      ...
      InputStream is = new ByteArrayInputStream("Hello OSS啊啊啊2222".getBytes());

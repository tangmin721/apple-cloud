...
public class CodeGenerator {
  ...
  public void setClazz(Class<?> clazz) {
    this.clazz = clazz;
    if (clazz.getAnnotation(Entity.class) == null || StringUtils
        .isBlank(clazz.getAnnotation(Entity.class).value())) {
      throw new BizException(BizExceptionEnum.SYS_EXCEPTION.getCode(),
          "@Entity(\"t_table_name\") is must not null");
    }
